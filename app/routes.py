...
def get_resultados():
    cache_key = 'maismilionaria:resultados'
    ...
    try:
        logger.info(f"Buscando dados na API: {API_BASE_URL}/maismilionaria")
        response = requests.get(f"{API_BASE_URL}/maismilionaria")
...
def get_digitos():
    cache_key = 'maismilionaria:digitos'
