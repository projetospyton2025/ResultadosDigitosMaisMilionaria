document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchDigitosResults() {
        ...
        const tableBody = document.getElementById('MaisMilionariaResults').getElementsByTagName('tbody')[0];
    ...
    function renderResults(results) {
        ...
        if (!resultsInfoDiv) {
            ...
            const tableContainer = document.getElementById('MaisMilionariaResults').parentNode;
            tableContainer.insertBefore(infoDiv, document.getElementById('MaisMilionariaResults'));
        } else {
